...
# dataset comes from this NIH link: https://nihcc.app.box.com/v/DeepLesion/folder/50715173939
# Ke Yan,  Xiaosong  Wang,  Le  Lu,  Ronald  M.  Summers,
# "DeepLesion: Automated  Mining  of Large-Scale Lesion Annotations and Universal Lesion
# Detection with Deep Learning", Journal of Medical Imaging5(3), 036501 (2018), doi: 10.1117/1.JMI.5.3.036501


# dataset comes out to around 220 GB
# it would be wise to download a much smaller batch at first to do preliminary testing
links = [
...
url.urlretrieve(md5_link, "MD5_checksums.txt")  # download the MD5 checksum file
